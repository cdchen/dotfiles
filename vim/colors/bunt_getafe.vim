...
hi Search          guifg=#F8FFF9   guibg=#AEEE00   gui=none            ctermfg=15      ctermbg=234
...
hi Cursor          guifg=#1B1D1E   guibg=#AEEE00                       ctermfg=234     ctermbg=202
...
hi IncSearch       guifg=#1B1D1E   guibg=#FFDC00                       ctermfg=234     ctermbg=248
hi LineNr          guifg=#5A7085   guibg=#000000                       ctermfg=60      ctermbg=0
hi NonText         guifg=#eeeeee   guibg=#1B1D1E                       ctermfg=7       ctermbg=234
hi Search          guifg=#1B1D1E   guibg=#FFDC00                       ctermfg=15      ctermbg=204
...
hi Visual                          guibg=#FF358B                                       ctermbg=60
