...
if exists("python_highlight_all") && python_highlight_all != 0
  ...
  if !exists("python_highlight_long_lines")
    let python_highlight_long_lines = 1
  endif
endif
...
if exists("python_highlight_long_lines") && python_highlight_long_lines != 0
  syn match pythonLongLines "\%>80v.\+"
endif
