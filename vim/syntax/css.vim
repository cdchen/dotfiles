...
" HTML 5 elements
syn keyword cssTagName section nav article aside hgroup header footer
syn keyword cssTagName address mark progress meter ruby rt rp figure
syn keyword cssTagName video audio canvas caption datalist keygen output
syn keyword cssTagName details command
